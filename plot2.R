plot2 <- function() {
# This function generates the single-variable line graph for Global Active Power
# to plot2.png using the base graphics package
#
...
# Outputs   : 'plot2.png' in current working directory
#    
...
#
    ...
    cat("Generating the single variable line graph plot to 'plot2.png' file\n")
    
    # Set the graphics device to png and destination output to plot2.png
    png(file="plot2.png",width=480,height=480)
    
    # Generate the line graph plot with plot()
