plot3 <- function() {
# This function generates the multi-variable line graph to plot3.png using the
...
# Outputs   : 'plot3.png' in current working directory
#    
    ...
    cat("Generating the multi-variable line graph plot to 'plot3.png' file.\n")
    
    # Set the graphics device to png and destination output to plot3.png
    png(file="plot3.png",width=480,height=480)
    
    # Generate the line graph plot for the first variable with plot()
    plot(data$DateTime,data$Sub_metering_1,xlab="",type='l',
         ylab="Energy sub metering")

    # Add second and third variables to above line graph plot with lines()
    lines(data$DateTime,data$Sub_metering_2,col="red",type='l')
    lines(data$DateTime,data$Sub_metering_3,col="blue",type='l')

    # Add legend to above line graph plot with legend()
    legend("topright",
